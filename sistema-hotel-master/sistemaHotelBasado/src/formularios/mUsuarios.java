...
public class mUsuarios extends javax.swing.JFrame {
    ...
    private mUsuariosModificar ModuloUserVisible = new mUsuariosModificar();
    ...
    private void initComponents() {
        ...
        jPanel2.add(btn_back, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 40, 30, 30));

        letras17.setFont(letras17.getFont().deriveFont(letras17.getFont().getStyle() | java.awt.Font.BOLD, 26));
        letras17.setText("Usuarios");
        jPanel2.add(letras17, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 60, -1, -1));
        ...
        jPanel2.add(btn_registrar1, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 40, 20, 30));
        ...
        jPanel2.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 110, 530, 197));

        jPanel1.setBackground(new java.awt.Color(255, 255, 255));
        jPanel1.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        btn_eliminar1.setBackground(new java.awt.Color(255, 204, 0));
        btn_eliminar1.setFont(new java.awt.Font("Alef", 1, 12)); // NOI18N
        btn_eliminar1.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 2, true));
        ...
        jPanel1.add(btn_eliminar1, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 0, 20, 30));

        btn_eliminar.setFont(new java.awt.Font("Alef", 1, 12)); // NOI18N
        btn_eliminar.setText("Eliminar");
        btn_eliminar.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 2, true));
        ...
        jPanel1.add(btn_eliminar, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 0, 90, 30));

        btn_modificar.setFont(new java.awt.Font("Alef", 1, 12)); // NOI18N
        btn_modificar.setText("Añadir / Modificar");
        btn_modificar.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 2, true));
        ...
        jPanel1.add(btn_modificar, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 0, 140, 30));

        btn_modificar1.setBackground(new java.awt.Color(255, 204, 0));
        btn_modificar1.setFont(new java.awt.Font("Alef", 1, 12)); // NOI18N
        btn_modificar1.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 2, true));
        ...
        jPanel1.add(btn_modificar1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 0, 20, 30));

        btn_buscar.setFont(new java.awt.Font("Alef", 1, 12)); // NOI18N
        btn_buscar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/formularios/lupa.png"))); // NOI18N
        ...
        jPanel1.add(btn_buscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 0, 40, 30));

        btn_buscar1.setBackground(new java.awt.Color(255, 204, 0));
        btn_buscar1.setFont(new java.awt.Font("Alef", 1, 12)); // NOI18N
        btn_buscar1.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 2, true));
        ...
        jPanel1.add(btn_buscar1, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 0, 20, 30));

        jPanel2.add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 320, 360, 30));

        jSeparator1.setBackground(new java.awt.Color(255, 255, 255));
        jSeparator1.setForeground(new java.awt.Color(255, 255, 255));
        jSeparator1.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 2, true));
        jPanel2.add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 20, 640, 370));

        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(-10, 0, 740, 440));
    ...
    private void abrirModificar() {
        ModuloUserVisible.setVisible(true);
    }
