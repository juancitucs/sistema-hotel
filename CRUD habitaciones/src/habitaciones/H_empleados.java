...
public class H_empleados extends javax.swing.JFrame {
    ...
    void editar(){
        ...
        String sql="update habitaciones set tipo_habitacion='"+tipo+"',precio_por_noche='"+precio+"',estado='"+estado+"',descripcion='"+descripcion+"',comodidades='"+comodidades+"' where habitacion_id="+id;
        if(precio.equals("")){
